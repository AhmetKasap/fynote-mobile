...
/// @nodoc
@JsonSerializable()
class _$FolderModelImpl extends _FolderModel {
  ...
  @override
  String toString() {
    return 'FolderModel(id: $id, userId: $userId, name: $name, icon: $icon, color: $color, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
